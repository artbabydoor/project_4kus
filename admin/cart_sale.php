...
<hr>
 ...
 <?php include 'menu_bar.php';?>
    <div class="col-md-9">
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="cart_sale.php">ตรวจเบิกวัตถุดิบ<span class="badge"><?php echo $meQty; ?></span></a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </div><!--/.container-fluid -->
            </div>
			<h3>ตรวจเบิกวัตถุดิบ</h3>
            ...
            {
                ?>
                <form action="update_sale_item.php" method="post" name="fromupdate">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
							...
							?>
                                    ...
                                    <td>
                                        <a class="btn btn-danger btn-lg" href="delete_sale_item.php?itemId=<?php echo $meResult['id']; ?>" role="button">
                            ...
                            <tr>
                                <td colspan="8" style="text-align: right;">
                                    ...
                                    <a href="confirm_sale_item.php" type="button" onclick="return confirm('คุณต้องการเพิ่มสินค้า ?')"class="btn btn-primary btn-lg">เบิกวัตถุดิบ</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
