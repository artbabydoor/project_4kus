                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li ><a href="sale_item.php">หน้าแสดงวัตถุดิบ</a></li>
...
<?php
if($action == 'exists'){
    echo "<div class=\"alert alert-warning\">เพิ่มจำนวนวัตถุดิบแล้ว</div>";
}
if($action == 'add'){
    echo "<div class=\"alert alert-success\">เพิ่มวัตถุดิบเรียบร้อยแล้ว</div>";
}
if($action == 'order'){
                ...
                <tbody>
                    ...
                    while ($meResult = mysql_fetch_assoc($meQuery))
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-lg" href="check_sale_item.php?itemId=<?php echo $meResult['id']; ?>" role="button">
